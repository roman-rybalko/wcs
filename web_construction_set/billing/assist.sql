create table assist_transactions(id integer primary key auto_increment not null, user_key integer, time integer not null, order_number varchar(128) not null, order_amount double, order_currency varchar(3), recurring integer(1), bill_number varchar(32), url varchar(1024));
...
create table assist_log(id integer primary key auto_increment not null, user_key integer, time integer not null, order_number integer, bill_number integer, data varchar(16384));
create index assist_log_idx1 on assist_log(user_key);
create index assist_log_idx2 on assist_log(time);
create index assist_log_idx3 on assist_log(order_number);
create index assist_log_idx4 on assist_log(bill_number);
